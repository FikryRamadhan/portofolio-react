const dataProject = [
    { 
        id: 1, 
        title: "Web Operational", 
        desc: "This Project for operational in PT-Adiva Sumber Solusi", 
        type: "web", 
    ...
    { 
        id: 3, 
        title: "Traveloop", 
        desc: "This project for booking hotel in indonesia best hotel", 
        type: "web", 
    ...
    { 
        id: 4, 
        title: "Spicy-X", 
        desc: "Spicy-X is a platform for buying UMKM products in SMK Pertiwi Kuningan", 
        type: "web", 
    ...
    { 
        ...
        desc: "This Project for survey application in Kuningan City", 
        type: "web", 
    ...
    { 
        id: 6, 
        title: "P2D", 
        desc: "This project for monitoring growth of children", 
        type: "web", 
    ...
    { 
        id: 8, 
        title: "Web Galeri", 
        desc: "This web application for showcasing art gallery", 
        type: "web", 
    ...
    { 
        id: 9, 
        title: "Arsip-App", 
        desc: "This application for monitoring archives in the agriculture department", 
        type: "web", 
        image: "/project/arsip-surat.png", 
    ...
    { 
        id: 10, 
        title: "E-Lope", 
        desc: "Platform for online learning", 
        type: "web", 
    ...
    { 
        id: 11, 
        title: "API Service", 
        desc: "This API provides data for various applications", 
        type: "web", 
