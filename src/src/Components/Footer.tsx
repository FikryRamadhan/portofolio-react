            ...
            <div className="container">
                <div className="flex flex-wrap items-center justify-center lg:ml-44">
                    <div className="w-full px-4 mb-12 text-slate-300 font-medium md:w-1/3">
                        ...
                        <p className="text-sm">A professionally designed web portfolio showcasing my expertise in web development, UI/UX design, and mobile development. This platform offers a range of services to help bring your digital projects to life, ensuring a seamless and user-friendly experience tailored to your needs, anytime and anywhere.</p>

                    </div>
                    <div className="w-full px-4 mb-12 md:w-1/3 lg:ml-40">
